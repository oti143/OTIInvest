        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-24 w-full">
          <div className="max-w-xl">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-gold/30 bg-gold/10 text-gold text-sm font-medium mb-8">
              ...
              Limited — Only 6,000 Seats Available
              <Star size={14} fill="currentColor" />
            </div>
            ...
            <h1 className="font-serif text-5xl sm:text-6xl font-bold leading-tight mb-6">
              ...
              <br />
              <span className="gold-text">Prosper Tomorrow.</span>
            </h1>

            <p className="text-muted-foreground text-lg leading-relaxed mb-6">
              A trusted long-term share investment plan designed for your future wealth. Managed by{" "}
              <span className="text-gold font-semibold">Co-Applicant Mr. Manoj</span>.
            </p>
              ...
              {/* Email */}
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-foreground font-semibold text-sm group-hover:text-gold transition-colors">{CONTACT_EMAIL}</p>
                    </div>
                  </a>

                  <a
                    href={`https://wa.me/${WHATSAPP_CONTACT}?text=${WHATSAPP_MSG}`}
                    target="_blank"
            ...
            <div className="navy-card rounded-xl p-6 border-gold/20">
              ...
              {contactSent ? (
                ...
                <form onSubmit={handleContact} className="space-y-4">
                  ...
                  <a
                    href={`mailto:${CONTACT_EMAIL}?subject=OTI Investment Enquiry from ${encodeURIComponent(contactForm.name)}&body=${encodeURIComponent(contactForm.message)}`}
